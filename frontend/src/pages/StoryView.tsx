        ...
        <div className="w-full mx-auto p-2 sm:p-8 max-w-full">
          ...
          <div className="sticky top-0 z-10 bg-gradient-to-r from-blue-100 via-white to-indigo-100 dark:from-blue-950 dark:via-slate-900 dark:to-indigo-950 backdrop-blur-md border-b border-blue-100 dark:border-blue-900 flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 shadow-xl rounded-b-2xl mb-6 sm:mb-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold bg-gradient-to-r from-blue-700 to-indigo-500 dark:from-orange-300 dark:to-pink-400 bg-clip-text text-transparent flex items-center gap-3 tracking-tight">Novel View</h2>
            </div>
            ...
            <div className="md:w-3/4 flex-1 min-w-0">
              {chapters.length > 0 ? (
                <div className="max-w-2xl w-full mx-auto bg-white dark:bg-slate-900 rounded-2xl shadow-2xl p-0 my-8 animate-fadeIn">
                  {chapterEditMode ? (
                    ...
                    <div className="space-y-4 p-6">
                      <div className="flex justify-between items-start">
                        <div>
                          <h2 className="text-2xl font-bold text-blue-700 dark:text-orange-300 mb-2">
                            {chapters[currentChapterIndex]?.title}
                          </h2>
                        </div>
                        <Button variant="primary" onClick={handleEditChapter} className="flex items-center gap-2">
                          <FiEdit className="w-4 h-4" />
                          Edit Chapter
                        </Button>
                      </div>
                      <div className="prose prose-blue dark:prose-invert max-w-none text-base leading-relaxed text-gray-900 dark:text-gray-100 whitespace-pre-line">
                ...
                <div className="text-center py-12">
                  <h3 className="text-xl font-semibold text-blue-700 dark:text-orange-300 mb-4">No Chapters Yet</h3>
